...
public final class StringUtils {
    ...
    private static int findNextWord(final char[] buffer, final int idx, final char[] delimiterChars) {
        ...
        while (i < len) {
            ...
            final boolean isDelimiter = (delimiterChars == null ? (Character.isWhitespace(ch)) : (Arrays.binarySearch(delimiterChars, ch) >= 0));
            if (isDelimiter) {
    ...
    public static String capitalizeWords(final Object target, final Object delimiters) {
        ...
        final char[] delimiterChars = (delimiters == null ? null : delimiters.toString().toCharArray());
