...
public final class VersionUtils {
    ...
    public static final class VersionSpec {
        ...
        private VersionSpec(
            ...
            this.versionCore = (patch != null) ? String.format("%d.%d.%d", Integer.valueOf(major), minor, patch) : (minor != null) ? String.format("%d.%d", Integer.valueOf(major), minor) : String.valueOf(major);
