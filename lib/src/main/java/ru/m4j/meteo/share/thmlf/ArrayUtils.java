...
public final class ArrayUtils {
    ...
    private static Object[] toArray(final Class<?> componentClass, final Object target) {
        ...
        if (target instanceof Iterable<?>) {
            ...
            final List<Object> elements = new ArrayList<>(5); // init capacity guessed - not know from iterable.
            ...
            final Object[] result = (Object[]) Array.newInstance(computedComponentClass, elements.size());
    ...
    public static <T, X> X[] copyOf(final T[] original, final int newLength, final Class<? extends X[]> newType) {
        final X[] newArray = (newType == (Object) Object[].class) ? (X[]) new Object[newLength] : (X[]) Array.newInstance(newType.getComponentType(), newLength);
